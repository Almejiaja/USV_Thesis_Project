...
def display_result(result, frame, labels):
    ...
    for obj in result:
        ...
        if labels[_id]== "person" or labels[_id]== "boat":
...
if __name__ == "__main__":
    ...
    #model_path = 'data/detect.tflite' #SSDMovileNetV1 mAp 22.5% 5 fps
    model_path = 'data/lite-model_efficientdet_lite0_detection_default_1.tflite'#mAp 25.69% 2.2 Fps
...
# used to record the time at which we processed current frame
    ...
    while True:
        ...
        cv2.putText((0, 0), fps , (10, 30), cv2.FONT_HERSHEY_COMPLEX, 0.5, (0, 255, 0), 1, cv2.LINE_AA)
